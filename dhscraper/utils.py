...
def extract_urls(abstract):
    ...
    try:
        for url_match in regex.finditer(URL_PATTERN, abstract, timeout=20):
            ...
            # catch continuation of the path if split across lines, Zenodo test case mw2013.museumsandtheweb.com/...;
            # Adho test cases http://digital.law.washington.edu/dspace-, http://www.californialawreview.org/wp-, propublica.org
